<template>
  <ApplicationTypeView title="«Руководства по эксплуатации»">
    <div class="application-content">
      <p class="text-body-1 mb-4">
        Заявки на разработку руководств по эксплуатации
      </p>
      ...
      <v-form ref="form" @submit.prevent="submitApplication">
        <v-card class="mb-4" variant="outlined" elevation="0">
          <v-card-text>
            ...
            <v-select
              v-model="application.manualType"
              label="Тип руководства"
              :items="[
                'Руководство по эксплуатации для ТР ТС 010/2011',
                'Руководство по эксплуатации для ТР ТС 004/2011',
                'Руководство по эксплуатации для ТР ТС 032/2013',
                'Руководство по эксплуатации для ТР ТС 020/2011'
              ]"
              variant="outlined"
              density="comfortable"
              class="mb-3"
...
const submitApplication = () => {
  ...
  console.log('Submitting manual application:', application.value)
